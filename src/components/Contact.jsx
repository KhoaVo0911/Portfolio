  ...
  return (
    ...
    >
      <Card className="w-full max-w-2xl p-10 md:p-16 bg-neutral-800/90 border-none shadow-2xl rounded-3xl">
        <div className="mb-10">
          <p className="text-lg font-semibold text-neutral-400 mb-1 tracking-widest uppercase font-beckman">
            Get in touch
          </p>
          <h2 className="text-5xl font-extrabold text-white mb-2 leading-tight font-mova">
        ...
        <form ref={form} onSubmit={sendEmail} className="space-y-7">
          ...
          >
            <label className="block text-base font-medium text-neutral-200 mb-2 font-rexlia">
              YOUR NAME
            </label>
            <Input
              name="name"
          ...
          >
            ...
            <textarea
              ...
              className="w-full px-4 py-3 rounded-xl bg-neutral-900 text-white placeholder:text-neutral-500 border border-neutral-700 focus:border-white focus:ring-2 focus:ring-white/40 outline-none transition resize-none font-michroma"
            ></textarea>
          </motion.div>
          <motion.div
            ref={refBtn}
          ...
          >
            <Button
              type="submit"
              disabled={loading}
              className="w-full gap-2 bg-white text-black hover:bg-neutral-200 font-bold text-lg py-3 rounded-xl flex items-center justify-center font-rexlia"
            >
              {loading ? (
                "Sending..."
              ) : (
          ...
          {success === true && (
            <p className="text-green-500 mt-2 text-center font-semibold font-michroma">
              Message sent successfully!
            </p>
          )}
          {success === false && (
            <p className="text-red-500 mt-2 text-center font-semibold font-michroma">
